...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The queue order is incorrect. Sue appears before Bob when Bob should go first.
    ...
    // Defect(s) Found: The queue order is incorrect. Sue appears before Bob again, showing rotation order is wrong.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The queue order is wrong. Sue comes before Bob, and infinite-turn handling may be off.
    ...
    // Defect(s) Found: Wrong order. Sue comes first instead of Tim, and infinite-turn handling may be off.
